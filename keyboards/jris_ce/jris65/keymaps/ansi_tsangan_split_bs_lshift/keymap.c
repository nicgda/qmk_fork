...
/* Keymap
        Esc      1        2        3        4        5        6        7        8        9        0         -       =        BackSpc  Del     PrntScr
        Tab      Q        W        E        R        T        Y        U        I        O        P        [        ]        \        PgUp
        Caps     A        S        D        F        G        H        J        K        L        ;        '                 Enter    PgDn
        Sh_L     MO(1)    Z        X        C        V        B        N        M        ,        .        /        Sh_R     Up       MO(1)
        Ct_L     GUI_L    Alt_L                               SPACE                               Atl_R             Left     Down     Right
*/

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [0] = LAYOUT_65_ansi_tsangan_split_bs_lshift(
    ...
    [1] = LAYOUT_65_ansi_tsangan_split_bs_lshift(
